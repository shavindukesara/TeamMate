...
public class Menu {
            ...
            try {
                switch (choice) {
                    ...
                    case "9" -> {
                        ...
                        System.out.print("Enter attempts for rebalance: ");
                        String s = scanner.nextLine().trim();
                        int attempts = s.isEmpty() ? 15 : Integer.parseInt(s);
                        System.out.print("Random mode? (y/n): ");
                    ...
                    case "10" -> {
                        // Super-balance
                        System.out.print("Enter maxTotalAttempts: ");
    ...
    private void printAdminMenu() {
        ...
        System.out.println("9  - Rebalance Teams");
        System.out.println("10 - Super-Balance Teams");
        System.out.println("0  - Exit");
        System.out.println("=".repeat(55));
    ...
    private void printParticipantMenu() {
        ...
        System.out.println("5 - Participants Statistics");
        System.out.println("8 - Logout");
        System.out.println("0 - Exit");
        System.out.println("=".repeat(55));
        System.out.print("Enter Your Choice: ");
